        ...
        <Card className="bg-gray-900/50 border-gray-800 text-center">
          <CardContent className="p-8">
            <div className="mb-6">
              ...
              <h1 className="text-2xl font-bold text-white mb-2">Tournament Submitted!</h1>
            ...
            <div className="space-y-3">
              <Link href="/submit/tournament">
                <Button className="w-full bg-red-500 hover:bg-red-600 text-white">Submit Another Tournament</Button>
              </Link>
              <Link href="/dashboard">
                <Button
                  variant="outline"
