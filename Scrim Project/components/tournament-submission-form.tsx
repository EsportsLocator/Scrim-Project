...
import { CalendarIcon, Upload, Trophy, CheckCircle } from "lucide-react"
...
export function TournamentSubmissionForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Your tournament has been submitted for review.",
    })
  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={cn("bg-gray-800 border-gray-700 text-white", errors.time && "border-red-500")}
                />
        ...
        <DialogContent className="bg-gray-900 border-gray-800 text-white">
          ...
          <div className="space-y-4">
            <p className="text-gray-300">
              Your tournament has been submitted for review. We'll notify you once it's approved and live on the
              platform.
            </p>
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <p className="text-blue-400 text-sm">Review typically takes 24-48 hours</p>
            </div>
            <div className="flex gap-3">
              <Button onClick={resetForm} className="flex-1 bg-blue-500 hover:bg-blue-600">
